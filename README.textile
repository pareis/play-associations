...
I have created a play module that does just that. Whenever you invoke one of the operations that changes a part of the association, then the module completes this operation on all other affected parts. This includes not only the new target and it's opposite reference, but it also manages to unlink a target object from its current associated object. All hassle free and safe.
...
You can check it out at https://github.com/pareis/play-associations and as soon as available in the play modules repository
